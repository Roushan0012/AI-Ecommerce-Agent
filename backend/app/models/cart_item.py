...
from sqlalchemy import Numeric, Integer, DateTime, ForeignKey, CheckConstraint, UniqueConstraint
...
class CartItem(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("total_price >= 0", name="chk_cart_items_total_price_non_negative"),
    )
